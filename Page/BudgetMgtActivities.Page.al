page 57160 "Budget Manager Activities"
{
    Caption = 'Activities';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            cuegroup(Purchases)
            {
                ...
                field("Purch. Inv. With Budget"; Rec."Purch. Inv. With Budget")
                {
                    DrillDownPageId = "Purchase Invoices";
                }
                field("Purch. CrMemo With Budget"; Rec."Purch. CrMemo With Budget")
                {
                    DrillDownPageId = "Purchase Credit Memos";
                }
                field("Purch. Inv. Without Budget"; Rec."Purch. Inv. Without Budget")
                {
                    DrillDownPageId = "Purchase Invoices Not Budget";
                }
                field("Purch. CrMemo Without Budget"; Rec."Purch. CrMemo Without Budget")
                {
                    DrillDownPageId = "Purchase CrMemos Not Budget";
                }
            }
            cuegroup(Sales)
            {
                ...
                field("Sales CrMemos"; Rec."Sales CrMemos")
                {
            ...
            cuegroup(Historic)
            {
                ...
                field("Posted Purchase CrMemos"; Rec."Posted Purchase CrMemos")
                {
                ...
                field("Posted Sales CrMemos"; Rec."Posted Sales CrMemos")
                {
