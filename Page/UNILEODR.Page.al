page 57222 "UNILEO DR"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Group)
            {
                ...
                field("Period N-1"; Rec."Amount 2" * (-1))
                {
                    Caption = 'Period N-1';
                    Editable = false;
    ...
    actions
    {
        area(processing)
        {
            action("&Print")
            {
                ...
                trigger OnAction()
                var
                    ReportDR: Report "UNILEO DR";
                begin

                    Clear(ReportDR);
                    ReportDR.SetFilters(YearFilter, PeriodNumber);
                    ReportDR.RunModal;
                end;
            }
    ...
    var
        ...
        Text50000: Label 'DR - Income Statement by Nature';
        gDPreviousDate: Date;
