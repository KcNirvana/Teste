page 57065 "Consultation With Order Open"
{

    Caption = 'Consultation List With Order Open';
    ...
    begin
        ApplyFilters;
        CduConsultation.GetConsultationWithOrderOpen(Rec.GetFilter("Created by"), Rec.GetFilter("Section Code"),
