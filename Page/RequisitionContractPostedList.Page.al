page 57033 "Req. Contract Posted List"
{
    Caption = 'Posted Contract Requisition List';
    CardPageID = "Req. Contract Posted Card";
    Editable = false;
    PageType = List;
    SourceTable = Requisition;
    SourceTableView = SORTING("Requisition Code")
                      WHERE(Status = FILTER(Released | Rejected | Canceled | Closed),
