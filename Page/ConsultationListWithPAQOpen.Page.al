page 57064 "Consultation With PAQ Open"
{

    Caption = 'Consultation List With Open PAQ';
    ...
    begin
        ApplyFilters;
        CduConsultation.GetConsultationWithPAQOpen(Rec.GetFilter("Created by"), Rec.GetFilter("Section Code"),
