page 57066 "Consultation With Invoice Open"
{

    Caption = 'Consultation List With Invoice Open';
    ...
    begin
        ApplyFilters;
        CduConsultation.GetConsultationWithInvoiceOpen(Rec.GetFilter("Created by"), Rec.GetFilter("Section Code"),
