...
.field private g:Landroid/support/v4/app/aj;
...
.method constructor <init>(Landroid/support/v4/app/p;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/p;->a:Landroid/os/Handler;
...
# virtual methods
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/aj;
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/t;->f:Landroid/support/v4/d/h;
    ...
    iput-object v0, p0, Landroid/support/v4/app/t;->f:Landroid/support/v4/d/h;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/aj;-><init>(Ljava/lang/String;Landroid/support/v4/app/t;Z)V

    iget-object v1, p0, Landroid/support/v4/app/t;->f:Landroid/support/v4/d/h;
    ...
    :cond_2
    invoke-virtual {v0, p0}, Landroid/support/v4/app/aj;->a(Landroid/support/v4/app/t;)V
...
.method a(Landroid/support/v4/d/h;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/t;->f:Landroid/support/v4/d/h;
...
.method a(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/app/aj;->f:Z
...
.method a(Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/t;->g:Landroid/support/v4/app/aj;
...
.method i()Landroid/support/v4/app/v;
    .locals 1
...
.method j()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/t;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/aj;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/t;->g:Landroid/support/v4/app/aj;
    ...
    iget-boolean v0, v0, Landroid/support/v4/app/aj;->e:Z
...
.method l()V
    ...
    new-array v3, v2, [Landroid/support/v4/app/aj;
...
.method m()Landroid/support/v4/d/h;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-boolean v5, v2, Landroid/support/v4/app/aj;->f:Z
    ...
    :cond_1
    invoke-virtual {v2}, Landroid/support/v4/app/aj;->h()V

    iget-object v5, p0, Landroid/support/v4/app/t;->f:Landroid/support/v4/d/h;

    iget-object v2, v2, Landroid/support/v4/app/aj;->d:Ljava/lang/String;
