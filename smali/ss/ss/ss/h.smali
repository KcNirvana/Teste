...
# static fields
.field private static final a:[Lss/ss/ss/f;
...
.method static constructor <clinit>()V
    ...
    new-instance v2, Lss/ss/ss/f;

    sget-object v3, Lss/ss/ss/f;->e:LgK/f;

    const-string/jumbo v4, ""

    invoke-direct {v2, v3, v4}, Lss/ss/ss/f;-><init>(LgK/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lss/ss/ss/f;->b:LgK/f;
    ...
    sget-object v3, Lss/ss/ss/f;->c:LgK/f;
    ...
    sget-object v3, Lss/ss/ss/f;->d:LgK/f;
    ...
    sget-object v3, Lss/ss/ss/f;->a:LgK/f;
    ...
    invoke-direct {v2, v3, v4}, Lss/ss/ss/f;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object v0, Lss/ss/ss/h;->a:[Lss/ss/ss/f;

    invoke-static {}, Lss/ss/ss/h;->c()Ljava/util/Map;

    move-result-object v0

    sput-object v0, Lss/ss/ss/h;->b:Ljava/util/Map;

    return-void
.end method

.method static synthetic a(LgK/f;)LgK/f;
    .locals 1
    ...
    invoke-static {p0}, Lss/ss/ss/h;->b(LgK/f;)LgK/f;
...
.method static synthetic a()[Lss/ss/ss/f;
    .locals 1

    sget-object v0, Lss/ss/ss/h;->a:[Lss/ss/ss/f;

    return-object v0
.end method

.method private static b(LgK/f;)LgK/f;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0}, LgK/f;->a(I)B
    ...
    invoke-virtual {p0}, LgK/f;->a()Ljava/lang/String;
...
.method static synthetic b()Ljava/util/Map;
    ...
    sget-object v0, Lss/ss/ss/h;->b:Ljava/util/Map;
...
.method private static c()Ljava/util/Map;
    ...
    :goto_0
    sget-object v2, Lss/ss/ss/h;->a:[Lss/ss/ss/f;
    ...
    iget-object v2, v2, Lss/ss/ss/f;->h:LgK/f;
