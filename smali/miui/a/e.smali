...
.method public constructor <init>()V
    ...
    new-instance v0, Lmiui/a/f;

    invoke-direct {v0, p0}, Lmiui/a/f;-><init>(Lmiui/a/e;)V

    iput-object v0, p0, Lmiui/a/e;->b:Landroid/content/DialogInterface$OnClickListener;

    new-instance v0, Lmiui/a/g;

    invoke-direct {v0, p0}, Lmiui/a/g;-><init>(Lmiui/a/e;)V

    iput-object v0, p0, Lmiui/a/e;->c:Landroid/content/DialogInterface$OnClickListener;
...
.method private a()Landroid/app/Dialog;
    ...
    iget-object v1, p0, Lmiui/a/e;->a:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lmiui/a/e;->b:Landroid/content/DialogInterface$OnClickListener;

    invoke-direct {p0, v1, v0, v2}, Lmiui/a/e;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method static synthetic a(Lmiui/a/e;)Landroid/app/Dialog;
    .locals 1

    invoke-direct {p0}, Lmiui/a/e;->d()Landroid/app/Dialog;
...
.method static synthetic b(Lmiui/a/e;)Z
    .locals 1

    invoke-direct {p0}, Lmiui/a/e;->h()Z
...
.method private c()Landroid/app/Dialog;
    ...
    invoke-direct {p0}, Lmiui/a/e;->g()Z
    ...
    :goto_2
    iget-object v2, p0, Lmiui/a/e;->c:Landroid/content/DialogInterface$OnClickListener;

    iget-object v3, p0, Lmiui/a/e;->b:Landroid/content/DialogInterface$OnClickListener;

    invoke-direct {p0, v1, v0, v2, v3}, Lmiui/a/e;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
...
.method static synthetic c(Lmiui/a/e;)Landroid/app/Dialog;
    .locals 1

    invoke-direct {p0}, Lmiui/a/e;->e()Landroid/app/Dialog;
...
.method static synthetic d(Lmiui/a/e;)Landroid/app/Dialog;
    .locals 1

    invoke-direct {p0}, Lmiui/a/e;->f()Landroid/app/Dialog;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lmiui/a/e;->setTheme(I)V
    ...
    iput-object v0, p0, Lmiui/a/e;->a:Ljava/lang/String;

    const/4 v0, 0x0

    invoke-virtual {p0}, Lmiui/a/e;->getIntent()Landroid/content/Intent;
    ...
    :cond_1
    sget-object v1, Lmiui/a/e$1;->a:[I

    invoke-virtual {v0}, Lmiui/a/c$a;->ordinal()I
    ...
    invoke-direct {p0}, Lmiui/a/e;->a()Landroid/app/Dialog;
    ...
    invoke-direct {v1, p0, v0}, Lmiui/a/e$a;-><init>(Lmiui/a/e;Landroid/app/Dialog;)V

    invoke-virtual {p0}, Lmiui/a/e;->getFragmentManager()Landroid/app/FragmentManager;
    ...
    :pswitch_0
    invoke-direct {p0}, Lmiui/a/e;->b()Landroid/app/Dialog;
    ...
    :pswitch_1
    invoke-direct {p0}, Lmiui/a/e;->c()Landroid/app/Dialog;
