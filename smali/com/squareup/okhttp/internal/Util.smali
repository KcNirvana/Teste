...
.method public static deleteContents(Ljava/io/File;)V
    ...
    invoke-static {v3}, Lcom/squareup/okhttp/internal/Util;->deleteContents(Ljava/io/File;)V
...
.method public static discard(La/aa;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1

    :try_start_0
    invoke-static {p0, p1, p2}, Lcom/squareup/okhttp/internal/Util;->skipAll(La/aa;ILjava/util/concurrent/TimeUnit;)Z
    :try_end_0
...
.method public static sha1(La/j;)La/j;
    .locals 2
...
.method public static skipAll(La/aa;ILjava/util/concurrent/TimeUnit;)Z
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, La/aa;->timeout()La/ab;

    move-result-object v0

    invoke-virtual {v0}, La/ab;->hasDeadline()Z
    ...
    invoke-virtual {v0}, La/ab;->deadlineNanoTime()J
    ...
    invoke-virtual {v4, v8, v9}, La/ab;->deadlineNanoTime(J)La/ab;
    ...
    invoke-interface {p0, v4, v8, v9}, La/aa;->read(La/e;J)J
    ...
    invoke-virtual {v0}, La/ab;->clearDeadline()La/ab;
    ...
    invoke-virtual {v2, v0, v1}, La/ab;->deadlineNanoTime(J)La/ab;
