...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    invoke-static {p1, v0, v1, p2, p3}, Lcom/squareup/okhttp/internal/DiskLruCache;->create(Ljava/io/File;IIJ)Lcom/squareup/okhttp/internal/DiskLruCache;
...
.method static synthetic access$1000(La/i;)I
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0}, Lcom/squareup/okhttp/Cache;->readInt(La/i;)I
...
.method private static readInt(La/i;)I
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, La/i;->q()Ljava/lang/String;
...
.method get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v1, v3}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;->getSource(I)La/aa;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/squareup/okhttp/Cache$Entry;-><init>(La/aa;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
