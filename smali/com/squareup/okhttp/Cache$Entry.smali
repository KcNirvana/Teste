...
.method public constructor <init>(La/aa;)V
    ...
    invoke-interface {v2}, La/i;->q()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/squareup/okhttp/Cache;->access$1000(La/i;)I
    ...
    invoke-interface {p1}, La/aa;->close()V
    ...
    invoke-direct {p0, v2}, Lcom/squareup/okhttp/Cache$Entry;->readCertificateList(La/i;)Ljava/util/List;
...
.method private readCertificateList(La/i;)Ljava/util/List;
    .locals 6
    ...
    invoke-static {p1}, Lcom/squareup/okhttp/Cache;->access$1000(La/i;)I
    ...
    invoke-interface {p1}, La/i;->q()Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, La/j;->b(Ljava/lang/String;)La/j;

    move-result-object v4

    invoke-virtual {v4}, La/j;->f()[B
...
.method private writeCertArray(La/h;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, La/h;->b(Ljava/lang/String;)La/h;

    const/16 v0, 0xa

    invoke-interface {p1, v0}, La/h;->g(I)La/h;
    ...
    invoke-virtual {v0}, La/j;->b()Ljava/lang/String;
...
.method public writeTo(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Editor;->newSink(I)La/z;
    ...
    invoke-interface {v2, v1}, La/h;->b(Ljava/lang/String;)La/h;

    invoke-interface {v2, v6}, La/h;->g(I)La/h;
    ...
    invoke-interface {v2, v4}, La/h;->b(Ljava/lang/String;)La/h;
    ...
    invoke-direct {p0, v2, v0}, Lcom/squareup/okhttp/Cache$Entry;->writeCertArray(La/h;Ljava/util/List;)V
