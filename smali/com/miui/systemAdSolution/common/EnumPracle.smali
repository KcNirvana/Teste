...
.method protected constructor <init>(Landroid/os/Parcel;)V
    ...
    const-string/jumbo v5, "getSharedConstants"
    ...
    :cond_2
    const-string/jumbo v0, "the enum[%s] is not define."
    ...
    :cond_8
    const-string/jumbo v1, "the value[%s] which name is [%s] in the enum[%s] is not equal the value defined[%s]."
    ...
    :cond_9
    :try_start_2
    const-string/jumbo v0, "the name[%s] in the enum[%s] is not defined."
...
.method private noSupportLog(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    const-string/jumbo v0, "the value[%s] which name is [%s] in the enum[%s] is not support."
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v0}, Ljava/lang/Enum;->getClass()Ljava/lang/Class;
