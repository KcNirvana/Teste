.class public Lcom/miui/home/launcher/assistant/util/Util;
...
.method public static MD5_32(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/miui/home/launcher/assistant/util/Util;->byte2Hex(B)Ljava/lang/String;
...
.method public static createIntentByUri(Landroid/content/Context;Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    invoke-static {p0, v3, p2}, Lcom/miui/home/launcher/assistant/util/IntentUtil;->canResolveIntent(Landroid/content/Context;Landroid/content/Intent;Z)Z
...
.method public static getAppIcon(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    const-string/jumbo v6, "getAppIcon NameNotFound "
...
.method public static getAppName(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "getAppName NameNotFound "
...
.method public static getCardOrder(Landroid/content/Context;)Ljava/util/ArrayList;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-static {p0}, Lcom/miui/home/launcher/assistant/util/Util;->getCardOrderFromDb(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "getCardOrder = "
    ...
    invoke-static {v1}, Lcom/miui/home/launcher/assistant/util/Util;->getCardOrderFromStr(Ljava/lang/String;)Ljava/util/ArrayList;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v6, "getCardOrder Exception:"
    ...
    const-string/jumbo v6, "getCardOrder list:"
...
.method public static getCardOrderFromDb(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "com.miui.personalassistant.SETTINGS_ORDER_V9"

    const-string/jumbo v8, ""

    invoke-virtual {v6, v7, v8}, Lcom/miui/home/launcher/assistant/provider/AssistantContentStorage;->query(Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string/jumbo v6, "com.miui.personalassistant.SETTINGS_ORDER_V9"
    ...
    invoke-static {v1, v6}, Lcom/miui/home/launcher/assistant/util/CryptUtil;->decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static getCardOrderFromStr(Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getGuidePrivacy(Landroid/content/Context;)Ljava/lang/String;
    .locals 2
    ...
    const-string/jumbo v1, "https://api.assistant.miui.com/guide/privacyV2?appVersion="
    ...
    invoke-static {p0, v1}, Lcom/miui/home/launcher/assistant/util/Util;->getVersionCode(Landroid/content/Context;Ljava/lang/String;)I
...
.method public static getLabelView(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method public static getLanguage(Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lcom/miui/home/launcher/assistant/util/Util;->useLangCountryHl(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static getResourceUri(Landroid/content/Context;I)Landroid/net/Uri;
    ...
    invoke-static {v1, v2, p1}, Lcom/miui/home/launcher/assistant/util/Util;->getResourceUri(Landroid/content/res/Resources;Ljava/lang/String;I)Landroid/net/Uri;
    :try_end_0
...
.method private static getResourceUri(Landroid/content/res/Resources;Ljava/lang/String;I)Landroid/net/Uri;
    ...
    invoke-static {p1, v1, v2, v0}, Lcom/miui/home/launcher/assistant/util/Util;->makeResourceUri(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public static getThemeStyleFromBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    .locals 4
...
.method public static getThemeStyleFromId(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v3, v4, v2}, Lcom/miui/home/launcher/assistant/config/PALog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public static getVersionCode(Landroid/content/Context;Ljava/lang/String;)I
    ...
    const-string/jumbo v5, "getVersionCode NameNotFound "
...
.method public static gotoCardSettingActivity(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
    ...
    const-string/jumbo v1, "com.miui.personalassistant.CommonSettingActivity"
    ...
    :cond_1
    const-string/jumbo v1, "com.miui.personalassistant.CommonSettingDetailActivity"
...
.method public static gotoSettingActivity(Landroid/content/Context;Z)V
    .locals 2
    ...
    const-string/jumbo v1, "com.miui.personalassistant.CARDSET"
...
.method public static inStrArray([Ljava/lang/String;Ljava/lang/String;)Z
    .locals 5
...
.method public static inStrArrayIndex([Ljava/lang/String;Ljava/lang/String;)I
    .locals 3
...
.method public static installApk(Landroid/content/Context;Lcom/miui/home/launcher/assistant/ui/view/AssistHolderView;Ljava/lang/String;)V
    .locals 5
    ...
    invoke-virtual {p1, v2}, Lcom/miui/home/launcher/assistant/ui/view/AssistHolderView;->showUpgradeLoading(Z)V
    ...
    invoke-static {v2}, Lcom/market/sdk/MarketManager;->getManager(Landroid/content/Context;)Lcom/market/sdk/MarketManager;
    ...
    new-instance v4, Lcom/miui/home/launcher/assistant/util/Util$2;

    invoke-direct {v4, p1}, Lcom/miui/home/launcher/assistant/util/Util$2;-><init>(Lcom/miui/home/launcher/assistant/ui/view/AssistHolderView;)V

    invoke-virtual {v2, v3, v4}, Lcom/market/sdk/MarketManager;->installSystemPackage(Landroid/net/Uri;Lcom/market/pm/api/MarketInstallerListener;)V
    :try_end_0
    .catch Lcom/market/pm/api/ComponentNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "MarketInstaller service not exists."
...
.method public static isInstalled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "isInstalled NameNotFound "
...
.method public static declared-synchronized isKeyguardSecure(Landroid/content/Context;)Z
    ...
    const-class v2, Lcom/miui/home/launcher/assistant/util/Util;
...
.method public static isNetworkConnected(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/miui/home/launcher/assistant/util/Util;->getNetworkClass(Landroid/content/Context;)Ljava/lang/String;
...
.method public static openInMarket(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_1
    const-string/jumbo v1, "market://details?id=%s&ref=personalassistant&back=true"
...
.method public static showKeyguardDialog(Landroid/content/Context;)V
    ...
    new-instance v3, Lcom/miui/home/launcher/assistant/util/Util$1;

    invoke-direct {v3, p0}, Lcom/miui/home/launcher/assistant/util/Util$1;-><init>(Landroid/content/Context;)V
...
.method public static startActivityByUri(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :goto_1
    invoke-static {p0, v3}, Lcom/miui/home/launcher/assistant/util/IntentUtil;->canResolveIntent(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    const-string/jumbo v4, "no found"
...
.method public static startActivityByUriClearTask(Landroid/content/Context;Ljava/lang/String;)V
    .locals 6
...
.method public static startActivityByUriClearTop(Landroid/content/Context;Ljava/lang/String;)V
    .locals 6
...
.method public static startActivityNoHistory(Landroid/content/Context;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Lcom/miui/home/launcher/assistant/util/Util;->startActivityNoHistory(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static startActivityNoHistory(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    .locals 6
    ...
    :cond_2
    :goto_1
    invoke-static {p0, v1}, Lcom/miui/home/launcher/assistant/util/IntentUtil;->canResolveIntent(Landroid/content/Context;Landroid/content/Intent;)Z
