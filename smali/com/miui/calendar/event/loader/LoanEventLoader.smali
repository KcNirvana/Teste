.class public Lcom/miui/calendar/event/loader/LoanEventLoader;
.super Ljava/lang/Object;
.source "LoanEventLoader.java"


# static fields
.field private static final TAG:Ljava/lang/String; = "CalThd:D:LoanEventLoader"
...
.method public static loadLoanEvent(Landroid/content/Context;Ljava/util/Calendar;I)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lcom/miui/calendar/event/loader/LoanEventLoader;->parseLoanEvent(Landroid/content/Context;Lcom/miui/calendar/event/schema/Event;)Lcom/miui/calendar/event/schema/BaseEvent;
...
.method private static parseLoanEvent(Landroid/content/Context;Lcom/miui/calendar/event/schema/Event;)Lcom/miui/calendar/event/schema/BaseEvent;
    .locals 7
    ...
    const-string/jumbo v6, "loan_info"
    ...
    const-string/jumbo v4, "CalThd:D:LoanEventLoader"

    const-string/jumbo v5, "parseLoanEvent() epJson is null"
    ...
    const-string/jumbo v5, "parseLoanEvent(): loanInfoStr is empty"
    ...
    const-string/jumbo v5, "parseLoanEvent()"
    ...
    invoke-static {p1, v4}, Lcom/miui/calendar/event/schema/LoanEvent;->parseLoanEvent(Lcom/miui/calendar/event/schema/Event;Lorg/json/JSONObject;)Lcom/miui/calendar/event/schema/LoanEvent;
    :try_end_1
