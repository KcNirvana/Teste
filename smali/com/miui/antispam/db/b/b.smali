.class public Lcom/miui/antispam/db/b/b;
...
# virtual methods
.method public YG(Landroid/database/Cursor;)Lcom/miui/antispam/db/a/b;
    .locals 2

    new-instance v0, Lcom/miui/antispam/db/a/b;

    invoke-direct {v0}, Lcom/miui/antispam/db/a/b;-><init>()V
    ...
    invoke-virtual {v0, v1}, Lcom/miui/antispam/db/a/b;->setId(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/miui/antispam/db/a/b;->YD(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/miui/antispam/db/a/b;->YB(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/miui/antispam/db/a/b;->YC(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/miui/antispam/db/a/b;->setState(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/miui/antispam/db/a/b;->setType(I)V
...
.method public bridge synthetic YG(Landroid/database/Cursor;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/antispam/db/b/b;->YG(Landroid/database/Cursor;)Lcom/miui/antispam/db/a/b;
...
.method public YH(Ljava/lang/String;)Z
    .locals 9
    ...
    :try_start_0
    iget-object v0, p0, Lcom/miui/antispam/db/b/b;->context:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    invoke-virtual {p0}, Lcom/miui/antispam/db/b/b;->getUri()Landroid/net/Uri;
...
.method public YI(Landroid/util/SparseArray;)V
    .locals 10
    ...
    invoke-virtual {v0}, Lcom/miui/antispam/db/a/b;->getType()I
    ...
    invoke-virtual {v0}, Lcom/miui/antispam/db/a/b;->getState()I
    ...
    invoke-virtual {v0}, Lcom/miui/antispam/db/a/b;->Yz()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/miui/antispam/db/b/b;->ZD:Lmiui/provider/BatchOperation;

    invoke-virtual {v4, v0}, Lmiui/provider/BatchOperation;->add(Landroid/content/ContentProviderOperation;)V

    iget-object v0, p0, Lcom/miui/antispam/db/b/b;->ZD:Lmiui/provider/BatchOperation;
    ...
    iget-object v3, p0, Lcom/miui/antispam/db/b/b;->ZD:Lmiui/provider/BatchOperation;
...
.method public YJ(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    .locals 2

    const-string/jumbo v0, "select * from phone_list where number NOT LIKE \'%*\' AND number NOT LIKE \'***%\'"
    ...
    invoke-virtual {p0, v0}, Lcom/miui/antispam/db/b/b;->YK(Landroid/database/Cursor;)Ljava/util/List;
