...
.method public static seekDynamicSpotDataIndex([B)[I
    ...
    invoke-static {v8}, Lcom/android/gallery3d/exif/JpegHeader;->getByteArrayOfTag(S)[B

    move-result-object v2

    invoke-static {v9}, Lcom/android/gallery3d/exif/JpegHeader;->getByteArrayOfTag(S)[B
    ...
    invoke-direct {v0, v4}, Lcom/android/gallery3d/exif/CountedDataInputStream;-><init>(Ljava/io/InputStream;)V
    ...
    const-string/jumbo v9, "Invalid JPEG format"
    ...
    :cond_0
    invoke-static {v0}, Lcom/android/gallery3d/exif/ExifParser;->seekSOSIndex(Lcom/android/gallery3d/exif/CountedDataInputStream;)I

    move-result v5

    invoke-static {p0, v2, v5}, Lcom/android/camera/Util;->indexOf([B[BI)I
    ...
    invoke-static {p0, v7, v8}, Lcom/android/camera/Util;->indexOf([B[BI)I
    ...
    const-string/jumbo v9, "Invalid spot data, not found SOI of raw data."
    ...
    invoke-virtual {v0, v10, v11}, Lcom/android/gallery3d/exif/CountedDataInputStream;->skip(J)J
    ...
    const-string/jumbo v9, "Invalid dynamic light spot data"
    ...
    const-string/jumbo v9, "Invalid dynamic light spot depth data"
...
.method public static seekSOSIndex(Lcom/android/gallery3d/exif/CountedDataInputStream;)I
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/gallery3d/exif/CountedDataInputStream;->skip(J)J
    ...
    const-string/jumbo v3, "Invalid JPEG format."
