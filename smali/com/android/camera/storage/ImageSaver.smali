...
.method static synthetic -wrap1(Lcom/android/camera/storage/ImageSaver;Lcom/android/camera/ActivityBase;Landroid/net/Uri;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/storage/ImageSaver;->notifyNewImage(Lcom/android/camera/ActivityBase;Landroid/net/Uri;Z)V

    return-void
.end method

.method static synthetic -wrap2(Lcom/android/camera/storage/ImageSaver;Lcom/android/camera/ActivityBase;Landroid/net/Uri;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/storage/ImageSaver;->notifyNewVideo(Lcom/android/camera/ActivityBase;Landroid/net/Uri;)V
...
.method private notifyNewImage(Lcom/android/camera/ActivityBase;Landroid/net/Uri;Z)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/android/camera/storage/ImageSaver;->mLastImageUri:Landroid/net/Uri;
    ...
    invoke-virtual {p1, p2}, Lcom/android/camera/ActivityBase;->addSecureUri(Landroid/net/Uri;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private notifyNewVideo(Lcom/android/camera/ActivityBase;Landroid/net/Uri;)V
    .locals 2
    ...
    const-string/jumbo v1, "android.hardware.action.NEW_VIDEO"

    invoke-direct {v0, v1, p2}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    invoke-virtual {p1, v0}, Lcom/android/camera/ActivityBase;->sendBroadcast(Landroid/content/Intent;)V
...
.method public addImage(I[BLjava/lang/String;Ljava/lang/String;JLandroid/net/Uri;Landroid/location/Location;IILcom/android/gallery3d/exif/ExifInterface;IZZZZLjava/lang/String;Lcom/android/camera/PictureInfo;)V
    ...
    :cond_0
    new-instance v3, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;
    ...
    invoke-direct/range {v3 .. v23}, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;-><init>(Lcom/android/camera/storage/ImageSaver;Lcom/android/camera/ActivityBase;I[BLjava/lang/String;Ljava/lang/String;JLandroid/net/Uri;Landroid/location/Location;IILcom/android/gallery3d/exif/ExifInterface;IZZZZLjava/lang/String;Lcom/android/camera/PictureInfo;)V

    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Lcom/android/camera/storage/ImageSaver;->addImage(Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;)V
...
.method public onHostDestroy()V
    ...
    iput-object v3, p0, Lcom/android/camera/storage/ImageSaver;->mHandler:Landroid/os/Handler;

    iput-object v3, p0, Lcom/android/camera/storage/ImageSaver;->mActivity:Lcom/android/camera/ActivityBase;
...
.method public updateImage(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v1, v0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->mContext:Lcom/android/camera/ActivityBase;
