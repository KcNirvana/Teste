...
.field protected mContext:Lcom/android/camera/ActivityBase;
...
.method public constructor <init>(Lcom/android/camera/storage/ImageSaver;Lcom/android/camera/ActivityBase;I[BLjava/lang/String;Ljava/lang/String;JLandroid/net/Uri;Landroid/location/Location;IILcom/android/gallery3d/exif/ExifInterface;IZZZZLjava/lang/String;Lcom/android/camera/PictureInfo;)V
    .locals 3
    ...
    iput-object p2, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->mContext:Lcom/android/camera/ActivityBase;

    iput p3, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->saveType:I

    iput-object p4, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->data:[B

    iput-wide p7, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->date:J

    iput-object p9, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->uri:Landroid/net/Uri;

    iput-object p5, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->title:Ljava/lang/String;

    iput-object p6, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->oldTitle:Ljava/lang/String;
    ...
    iput p11, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->width:I

    iput p12, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->height:I

    move-object/from16 v0, p13

    iput-object v0, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->exif:Lcom/android/gallery3d/exif/ExifInterface;

    move/from16 v0, p14

    iput v0, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->orientation:I
    ...
    invoke-direct {v1, p10}, Landroid/location/Location;-><init>(Landroid/location/Location;)V
...
.method private notifySaveFailure()V
    ...
    iget-object v0, p0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->mContext:Lcom/android/camera/ActivityBase;
...
.method public save()V
    ...
    iget-object v2, v0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->mContext:Lcom/android/camera/ActivityBase;
    ...
    invoke-static {v2}, Lcom/android/camera/Util;->enableFakeThumbnail(Lcom/android/camera/ActivityBase;)Z
    ...
    invoke-static {v3, v0, v2}, Lcom/android/camera/storage/ImageSaver;->-wrap4(Lcom/android/camera/storage/ImageSaver;Lcom/android/camera/Thumbnail;Z)V
    ...
    iget-object v3, v0, Lcom/android/camera/storage/ImageSaver$ImageSaveRequest;->mContext:Lcom/android/camera/ActivityBase;
    ...
    invoke-static {v2, v3, v4, v5}, Lcom/android/camera/storage/ImageSaver;->-wrap1(Lcom/android/camera/storage/ImageSaver;Lcom/android/camera/ActivityBase;Landroid/net/Uri;Z)V
