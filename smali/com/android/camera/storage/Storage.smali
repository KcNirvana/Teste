...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput v1, Lcom/android/camera/storage/Storage;->MAX_WRITE_RETRY:I
...
.method public static addImage(Landroid/content/Context;Ljava/lang/String;JLandroid/location/Location;I[BIIZZZZZLjava/lang/String;Lcom/android/camera/PictureInfo;)Landroid/net/Uri;
    ...
    invoke-static {v11, v0, v1}, Lcom/android/camera/storage/Storage;->writeJpeg(Ljava/lang/String;[BZ)I
    ...
    const-string/jumbo v6, "addImage#writeJpeg tryout "
    ...
    sget v4, Lcom/android/camera/storage/Storage;->MAX_WRITE_RETRY:I
    ...
    const-string/jumbo v6, "addImage write "
    ...
    const-string/jumbo v6, "addImage file saved "
    ...
    const-string/jumbo v6, "addImage image uri -> "
...
.method private static writeJpeg(Ljava/lang/String;[BZ)I
    ...
    invoke-virtual {v2, v14, v15, v10}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    ...
    :goto_3
    :try_start_4
    instance-of v14, v3, Ljava/io/FileNotFoundException;
    ...
    const-string/jumbo v17, "Failed to write image, memory state(max:%d, total:%d, free:%d), file state(%s;%s;%s)"
    ...
    const-string/jumbo v14, "isDirectory"
    ...
    const-string/jumbo v14, "canWrite"
    ...
    invoke-static {v15, v14, v3}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    :cond_5
    :try_start_6
    const-string/jumbo v14, "not exists"

    goto :goto_4

    :cond_6
    const-string/jumbo v14, "isNotDirectory"

    goto :goto_5

    :cond_7
    const-string/jumbo v14, "canNotWrite"
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_0
    ...
    invoke-static {v15, v0, v3}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
