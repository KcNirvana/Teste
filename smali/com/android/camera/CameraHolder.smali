...
.method private constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/camera/CameraHolder;->mOpenCloseLock:Ljava/lang/Object;
...
.method public declared-synchronized open(IZI)Lcom/android/camera/CameraManager$CameraProxy;
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/camera/CameraHolder;->mOpenCloseLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v4}, Lcom/android/camera/CameraHolder;->cloneParameters(Landroid/hardware/Camera$Parameters;)Landroid/hardware/Camera$Parameters;
    ...
    const-string/jumbo v4, "fail to connect Camera"
    ...
    const-string/jumbo v5, "reconnect camera "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/android/camera/CameraHolder;->mCameraId:I
    ...
    const-string/jumbo v4, "reconnect failed."
...
.method public declared-synchronized release(Z)V
    ...
    iget-object v4, p0, Lcom/android/camera/CameraHolder;->mOpenCloseLock:Ljava/lang/Object;
