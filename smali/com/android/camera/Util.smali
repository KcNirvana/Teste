...
.method public static checkDeviceHasNavigationBar(Landroid/content/Context;)Z
    ...
    sget-boolean v1, Lcom/android/camera/Device;->IS_C3D:Z
...
.method public static getAILensIntent(II)Landroid/content/Intent;
    ...
    const-string/jumbo v1, "android.media.action.XIAOAI_CONTROL"
...
.method private static getAttributeIntValue(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
    ...
    const-string/jumbo v4, "get attribute "
...
.method public static getBytesFromFile(Ljava/io/File;)[B
    ...
    const-string/jumbo v8, "file is too large "
    ...
    const-string/jumbo v8, "Could not completely read file "
...
.method private static getColorMapXmlMapFile()Ljava/io/File;
    ...
    const-string/jumbo v1, "/vendor/etc/screen_light.xml"
    ...
    const-string/jumbo v1, "/system/etc/screen_light.xml"
...
.method private static initScreenLightColorMap()V
    ...
    sget-object v11, Lcom/android/camera/Util;->COLOR_TEMPERATURE_LIST:Ljava/util/List;
    ...
    sget-object v11, Lcom/android/camera/Util;->COLOR_TEMPERATURE_MAP:Ljava/util/List;
    ...
    const-string/jumbo v12, "screen_light"
    ...
    const-string/jumbo v12, "res/xml/screen_light.xml not found!"
    ...
    sget-object v11, Lcom/android/camera/Util;->SCREEN_VENDOR:Ljava/lang/String;
    ...
    invoke-static {v7}, Lcom/android/camera/Util;->skip(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_2
    ...
    invoke-static {v5}, Lcom/android/camera/Util;->safelyClose(Ljava/io/Closeable;)V

    instance-of v11, v7, Landroid/content/res/XmlResourceParser;
    ...
    const-string/jumbo v13, "load screen light parameters for "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    sget-object v13, Lcom/android/camera/Util;->SCREEN_VENDOR:Ljava/lang/String;
    ...
    :cond_9
    :try_start_5
    const-string/jumbo v11, "CCT"

    const/4 v12, 0x0

    invoke-static {v7, v11, v12}, Lcom/android/camera/Util;->getAttributeIntValue(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
    ...
    instance-of v12, v7, Landroid/content/res/XmlResourceParser;
...
.method public static insertImageToParallelService(Landroid/content/Context;JLjava/lang/String;)V
    ...
    const-string/jumbo v4, "media_tmp_path"
...
.method public static isForceNameSuffix()Z
    ...
    const-string/jumbo v1, "force_name_suffix"
...
.method public static isUriValid(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    const-string/jumbo v4, "IOException occurs when opening URI: "
...
.method public static setScreenEffect(Z)V
    ...
    invoke-static {v1, v0}, Lcom/android/camera/lib/compatibility/util/CompatibilityUtils;->setScreenEffect(II)V
