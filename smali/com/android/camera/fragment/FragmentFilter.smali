...
.method private onFilterSelected(IZ)V
    ...
    iget-object v3, v4, Lcom/android/camera/data/data/ComponentDataItem;->mValue:Ljava/lang/String;
    ...
    invoke-virtual {v4, v6, v5}, Lcom/android/camera/data/data/config/ComponentConfigFilter;->setClosed(ZI)V
    ...
    invoke-direct {p0, v2, p2}, Lcom/android/camera/fragment/FragmentFilter;->trackFilterChanged(IZ)V

    invoke-direct {p0, v2}, Lcom/android/camera/fragment/FragmentFilter;->persistFilter(I)V

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/FragmentFilter;->selectItem(I)V

    invoke-direct {p0, v2}, Lcom/android/camera/fragment/FragmentFilter;->onFilterChanged(I)V
    :try_end_0
    ...
    const-string/jumbo v6, "invalid filter id: "
