...
.method private requestZoomRatio(IZ)V
    ...
    const-string/jumbo v2, "CameraModule"

    const-string/jumbo v3, "Camera is taking picture, ignore request."
    ...
    invoke-interface {v1, p1, p2}, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;->onDualZoomValueChanged(IZ)V
...
.method public onClick(Landroid/view/View;)V
    ...
    const-string/jumbo v1, "CameraModule"
    ...
    const-string/jumbo v2, "Camera is taking picture, ignore event."
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->trackDualZoomChanged(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v1, v5}, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->requestZoomRatio(IZ)V

    iget v1, p0, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->mZoomRatioWide:I

    invoke-direct {p0, v1, v4}, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->requestZoomRatio(IZ)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    const-string/jumbo v3, "Camera is taking picture, ignore long click event."
    ...
    :cond_1
    new-instance v1, Lcom/android/camera/data/data/config/ComponentManuallyDualZoom;

    invoke-static {}, Lcom/android/camera/data/DataRepository;->dataItemRunning()Lcom/android/camera/data/data/runing/DataItemRunning;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/android/camera/data/data/config/ComponentManuallyDualZoom;-><init>(Lcom/android/camera/data/data/runing/DataItemRunning;)V

    invoke-direct {p0, v1}, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->initSlideZoomView(Lcom/android/camera/data/data/ComponentData;)V

    invoke-direct {p0}, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->showSlideView()V

    iput-boolean v4, p0, Lcom/android/camera/fragment/dual/FragmentDualCameraAdjust;->mPassTouchFromZoomButtonToSlide:Z
