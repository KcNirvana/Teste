...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, p0, Lcom/android/camera/ProximitySensorLock;->mProximityNear:Ljava/lang/Boolean;
    ...
    const-string/jumbo v4, "power_double_tap"

    invoke-static {v1, v4}, Landroid/text/TextUtils;->equals(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/camera/ProximitySensorLock;->mFromVolumeKey:Z

    :goto_0
    const-string/jumbo v4, "ProximitySensorLock"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "from volume key ->"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/camera/ProximitySensorLock;->mFromVolumeKey:Z
    ...
    iput-boolean v5, p0, Lcom/android/camera/ProximitySensorLock;->mJudged:Z

    new-instance v4, Landroid/os/HandlerThread;

    const-string/jumbo v5, "Proximity sensor lock"

    invoke-direct {v4, v5}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v4, p0, Lcom/android/camera/ProximitySensorLock;->mWorkerThread:Landroid/os/HandlerThread;

    iget-object v4, p0, Lcom/android/camera/ProximitySensorLock;->mWorkerThread:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->start()V

    new-instance v4, Lcom/android/camera/ProximitySensorLock$1;

    iget-object v5, p0, Lcom/android/camera/ProximitySensorLock;->mWorkerThread:Landroid/os/HandlerThread;

    invoke-virtual {v5}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v5

    invoke-direct {v4, p0, v5}, Lcom/android/camera/ProximitySensorLock$1;-><init>(Lcom/android/camera/ProximitySensorLock;Landroid/os/Looper;)V

    iput-object v4, p0, Lcom/android/camera/ProximitySensorLock;->mWorkerHandler:Landroid/os/Handler;
    ...
    :cond_2
    iput-boolean v5, p0, Lcom/android/camera/ProximitySensorLock;->mFromVolumeKey:Z
