...
.method public processorJpegAsync(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;)Z
    ...
    sget-object v5, Lcom/android/camera/effect/renders/SnapshotEffectRender;->TAG:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/camera/effect/renders/SnapshotEffectRender;->mActivity:Lcom/android/camera/ActivityBase;

    invoke-virtual {v5}, Lcom/android/camera/ActivityBase;->getThumbnailUpdater()Lcom/android/camera/ThumbnailUpdater;

    move-result-object v5

    iget-object v6, p0, Lcom/android/camera/effect/renders/SnapshotEffectRender;->mActivity:Lcom/android/camera/ActivityBase;

    invoke-static {v6}, Lcom/android/camera/Util;->enableFakeThumbnail(Lcom/android/camera/ActivityBase;)Z
    ...
    :goto_2
    invoke-virtual {v5, v2, v4, v3}, Lcom/android/camera/ThumbnailUpdater;->setThumbnail(Lcom/android/camera/Thumbnail;ZZ)V
    ...
    invoke-virtual {v3}, Lcom/android/camera/data/data/feature/DataItemFeature;->supportCameraDynamicLightSpot()Z
    ...
    invoke-virtual {v3, v8, p1}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public release()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->hasMessages(I)Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/camera/effect/renders/SnapshotEffectRender;->mReleasePending:Z
