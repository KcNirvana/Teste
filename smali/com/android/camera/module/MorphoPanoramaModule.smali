...
.method static synthetic -wrap7(Lcom/android/camera/module/MorphoPanoramaModule;Ljava/lang/String;Landroid/graphics/Rect;)V
    .locals 0
...
.method private addImageAsApplication(Ljava/lang/String;Landroid/graphics/Rect;I)V
    ...
    iget-object v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mMainHandler:Landroid/os/Handler;

    new-instance v4, Lcom/android/camera/module/MorphoPanoramaModule$3;

    invoke-direct {v4, p0, v2}, Lcom/android/camera/module/MorphoPanoramaModule$3;-><init>(Lcom/android/camera/module/MorphoPanoramaModule;Lcom/android/camera/Camera;)V
...
.method private setupCaptureParams()V
    ...
    iget v0, v8, Lcom/android/camera/PictureSize;->width:I

    move/from16 v16, v0

    iget v0, v8, Lcom/android/camera/PictureSize;->height:I

    move/from16 v17, v0

    invoke-static/range {v16 .. v17}, Lcom/android/camera/CameraSettings;->getPreviewAspectRatio(II)F
...
.method private stopPanoramaShooting(ZZ)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/camera/module/MorphoPanoramaModule$SaveOutputImageTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    invoke-direct {v2, p0}, Lcom/android/camera/module/MorphoPanoramaModule$1;-><init>(Lcom/android/camera/module/MorphoPanoramaModule;)V
...
.method public onPictureTaken([BLandroid/hardware/Camera;)V
    ...
    iput-boolean v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mRequestTakePicture:Z
    ...
    iget-object v4, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mSyncObj:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    iget-object v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;
    ...
    :cond_1
    :try_start_1
    iget-object v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCaptureInfoList:Ljava/util/ArrayList;
    ...
    check-cast v0, Lcom/android/camera/module/MorphoPanoramaModule$CaptureInfo;

    new-instance v2, Lcom/android/camera/module/MorphoPanoramaModule$StillImageData;

    iget v3, v0, Lcom/android/camera/module/MorphoPanoramaModule$CaptureInfo;->mId:I

    iget v5, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mPreviewCount:I

    iget-object v6, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mMotionData:[B

    invoke-direct {v2, v3, v5, p1, v6}, Lcom/android/camera/module/MorphoPanoramaModule$StillImageData;-><init>(II[B[B)V
    ...
    iget v3, v0, Lcom/android/camera/module/MorphoPanoramaModule$CaptureInfo;->mStatus:I
    ...
    const-string/jumbo v4, "onPictureTaken done"
    ...
    :try_start_2
    invoke-direct {p0, v3}, Lcom/android/camera/module/MorphoPanoramaModule;->stopPanoramaShooting(Z)V
    :try_end_2
    ...
    iget-object v5, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCameraPreviewBuff:[B

    invoke-virtual {v3, v5}, Lcom/android/camera/CameraManager$CameraProxy;->addCallbackBuffer([B)V

    const/4 v3, 0x1

    iput v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mPreviewSkipCount:I

    iget-object v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;

    invoke-virtual {v3, p0}, Lcom/android/camera/CameraManager$CameraProxy;->setPreviewCallbackWithBuffer(Landroid/hardware/Camera$PreviewCallback;)V
...
.method public onPictureTakenPreview([B)V
    ...
    iget-object v3, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mSyncObj:Ljava/lang/Object;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCaptureInfoList:Ljava/util/ArrayList;
    ...
    iget v2, v0, Lcom/android/camera/module/MorphoPanoramaModule$CaptureInfo;->mId:I
    ...
    invoke-direct {v1, v2, v4, p1, v5}, Lcom/android/camera/module/MorphoPanoramaModule$StillImageData;-><init>(II[B[B)V
    ...
    iget v2, v0, Lcom/android/camera/module/MorphoPanoramaModule$CaptureInfo;->mStatus:I
    ...
    iget-boolean v2, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mIsShooting:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;

    iget-object v4, p0, Lcom/android/camera/module/MorphoPanoramaModule;->mCameraPreviewBuff:[B

    invoke-virtual {v2, v4}, Lcom/android/camera/CameraManager$CameraProxy;->addCallbackBuffer([B)V
    ...
    invoke-virtual {v2, p0}, Lcom/android/camera/CameraManager$CameraProxy;->setPreviewCallbackWithBuffer(Landroid/hardware/Camera$PreviewCallback;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public onPreviewFrame([BLandroid/hardware/Camera;)V
    ...
    invoke-direct {v3, v4, v5}, Lcom/android/camera/module/MorphoPanoramaModule$CaptureInfo;-><init>(II)V
    ...
    invoke-direct {v2, v0, v1}, Lcom/android/camera/module/MorphoPanoramaModule$2;-><init>(Lcom/android/camera/module/MorphoPanoramaModule;[B)V
...
.method public startPanoramaShooting()V
    ...
    const-string/jumbo v2, "startPanoramaGP failed"
    ...
    const-string/jumbo v2, "startPanoramaShooting: mCameraDevice is null."
