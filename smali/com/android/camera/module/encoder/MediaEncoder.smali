...
.method protected drain()V
    ...
    iget-object v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mWeakMuxer:Ljava/lang/ref/WeakReference;

    invoke-virtual {v9}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/android/camera/module/encoder/MediaMuxerWrapper;

    if-nez v8, :cond_0

    iget-object v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->TAG:Ljava/lang/String;

    const-string/jumbo v10, "muxer is unexpectedly null"
    ...
    :cond_0
    iget-object v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mMediaCodec:Landroid/media/MediaCodec;
    ...
    :cond_2
    :goto_0
    iget-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mIsCapturing:Z
    ...
    :cond_4
    iget-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mSkipFrame:Z
    ...
    iget-wide v12, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mFirstFrameTime:J
    ...
    :goto_2
    iput-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mSkipFrame:Z

    :cond_5
    :try_start_0
    iget-object v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mMediaCodec:Landroid/media/MediaCodec;

    iget-object v10, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mBufferInfo:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mIsEOS:Z
    ...
    const-string/jumbo v10, "INFO_OUTPUT_BUFFERS_CHANGED"
    ...
    iget-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mMuxerStarted:Z
    ...
    invoke-virtual {v8, v6}, Lcom/android/camera/module/encoder/MediaMuxerWrapper;->addTrack(Landroid/media/MediaFormat;)I

    move-result v9

    iput v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mTrackIndex:I

    iget-object v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mSync:Ljava/lang/Object;
    ...
    iput-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mMuxerStarted:Z

    invoke-virtual {v8}, Lcom/android/camera/module/encoder/MediaMuxerWrapper;->start()Z
    ...
    :cond_a
    :try_start_2
    invoke-virtual {v8}, Lcom/android/camera/module/encoder/MediaMuxerWrapper;->isStarted()Z
    :try_end_2
    ...
    :try_start_3
    invoke-virtual {v8, v10, v11}, Lcom/android/camera/module/encoder/MediaMuxerWrapper;->wait(J)V

    iget-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mRequestStop:Z
    :try_end_3
    ...
    const-string/jumbo v11, "drain: unexpected status: "
    ...
    const-string/jumbo v10, "drain: BUFFER_FLAG_CODEC_CONFIG"
    ...
    invoke-virtual {v8, v9, v3, v10}, Lcom/android/camera/module/encoder/MediaMuxerWrapper;->writeSampleData(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    iget v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mFrame:I

    add-int/lit8 v9, v9, 0x1

    iput v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mFrame:I

    iget-object v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mBufferInfo:Landroid/media/MediaCodec$BufferInfo;

    iget-wide v10, v9, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iput-wide v10, p0, Lcom/android/camera/module/encoder/MediaEncoder;->prevOutputPTSUs:J
    ...
    iput-boolean v9, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mIsCapturing:Z
...
.method protected release()V
    ...
    check-cast v2, Lcom/android/camera/module/encoder/MediaMuxerWrapper;
    ...
    :cond_2
    iput-object v3, p0, Lcom/android/camera/module/encoder/MediaEncoder;->mBufferInfo:Landroid/media/MediaCodec$BufferInfo;
