...
.method private constructor <init>(IILcom/android/camera/ActivityBase;)V
    ...
    iput-object v0, p0, Lcom/android/camera/module/encoder/RenderHandler;->mActivityRef:Ljava/lang/ref/WeakReference;
...
.method public static final createHandler(Ljava/lang/String;IILcom/android/camera/ActivityBase;)Lcom/android/camera/module/encoder/RenderHandler;
    ...
    invoke-direct {v1, p1, p2, p3}, Lcom/android/camera/module/encoder/RenderHandler;-><init>(IILcom/android/camera/ActivityBase;)V
...
.method public final run()V
    ...
    sget-object v4, Lcom/android/camera/module/encoder/RenderHandler;->TAG:Ljava/lang/String;

    const-string/jumbo v5, "renderHandlerThread>>>"

    invoke-static {v4, v5}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v5, p0, Lcom/android/camera/module/encoder/RenderHandler;->mSync:Ljava/lang/Object;
    ...
    :try_start_0
    iput-boolean v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mRequestSetEglContext:Z

    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mRequestRelease:Z
    ...
    iput-boolean v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mIsReady:Z

    iget-object v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mSync:Ljava/lang/Object;
    ...
    :try_start_1
    iget-boolean v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mRequestRelease:Z
    :try_end_1
    ...
    :cond_1
    :try_start_3
    iget-boolean v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mRequestSetEglContext:Z
    ...
    iget-object v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mEgl:Lcom/android/camera/module/encoder/EGLBase;
    ...
    iget-object v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mActivityRef:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v4}, Lcom/android/camera/ui/V6CameraGLSurfaceView;->getGLCanvas()Lcom/android/gallery3d/ui/GLCanvasImpl;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mInputSurface:Lcom/android/camera/module/encoder/EGLBase$EglSurface;

    invoke-virtual {v4}, Lcom/android/camera/module/encoder/EGLBase$EglSurface;->makeCurrent()V

    monitor-enter v1

    :try_start_4
    iget-object v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mCanvas:Lcom/android/camera/effect/VideoRecorderCanvas;

    iget-object v5, p0, Lcom/android/camera/module/encoder/RenderHandler;->mExtTexture:Lcom/android/camera/effect/draw_mode/DrawExtTexAttribute;

    invoke-virtual {v4, v5}, Lcom/android/camera/effect/VideoRecorderCanvas;->draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)V

    iget-object v4, p0, Lcom/android/camera/module/encoder/RenderHandler;->mCanvas:Lcom/android/camera/effect/VideoRecorderCanvas;

    invoke-virtual {v4}, Lcom/android/camera/effect/VideoRecorderCanvas;->flush()V
    :try_end_4
    ...
    invoke-virtual {v4}, Lcom/android/camera/module/encoder/EGLBase$EglSurface;->swap()V
