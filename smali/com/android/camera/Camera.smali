...
.method static synthetic -get2(Lcom/android/camera/Camera;)Lcom/android/camera/module/loader/StartControl;
    .locals 1
...
.method static synthetic -get3(Lcom/android/camera/Camera;)I
    .locals 1
...
.method static synthetic -get4(Lcom/android/camera/Camera;)Ljava/lang/Runnable;
    .locals 1
...
.method private resumeCamera()V
    ...
    invoke-interface {v6}, Lcom/android/camera/module/Module;->unRegisterProtocol()V
    ...
    invoke-interface {v6, v10}, Lcom/android/camera/module/Module;->setActivity(Lcom/android/camera/Camera;)V
    ...
    invoke-virtual {v6, v7}, Lcom/android/camera/module/loader/StartControl;->setLastMode(I)Lcom/android/camera/module/loader/StartControl;
    ...
    iget-object v6, p0, Lcom/android/camera/Camera;->mCameraIntentManager:Lcom/android/camera/CameraIntentManager;

    invoke-virtual {v6}, Lcom/android/camera/CameraIntentManager;->checkCallerLegality()Z
    ...
    invoke-virtual {v6}, Lcom/android/camera/CameraIntentManager;->isActionPerformed()Z
    ...
    invoke-interface {v6, v7}, Lcom/android/camera/data/provider/DataProvider;->setTimeOut(Z)V
    ...
    invoke-interface {v6}, Lcom/android/camera/module/Module;->onResume()V
...
.method private setupCamera(Lcom/android/camera/module/loader/StartControl;)V
    ...
    new-instance v7, Lcom/android/camera/Camera$5;

    invoke-direct {v7, p0}, Lcom/android/camera/Camera$5;-><init>(Lcom/android/camera/Camera;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/camera/module/loader/CompletablePreFixCameraSetup;-><init>(Lcom/android/camera/module/Module;Lcom/android/camera/module/Module;ZLcom/android/camera/CameraScreenNail;Landroid/content/Intent;Landroid/os/Handler;ZZ)V
    ...
    invoke-direct {v0, p0, v1, v9}, Lcom/android/camera/storage/ImageSaver;-><init>(Lcom/android/camera/ActivityBase;Landroid/os/Handler;Z)V

    iput-object v0, p0, Lcom/android/camera/Camera;->mImageSaver:Lcom/android/camera/storage/ImageSaver;

    invoke-direct {p0, v11}, Lcom/android/camera/Camera;->setTranslucentNavigation(Z)V
...
.method public onModeSelected(Lcom/android/camera/module/loader/StartControl;)V
    ...
    invoke-static {v9}, Lcom/android/camera/CameraStatUtil;->modeIdToName(I)Ljava/lang/String;
    ...
    invoke-static {v9, v0, v2}, Lcom/android/camera/statistic/ScenarioTrackUtil;->trackSwitchModeStart(IIZ)V
    ...
    invoke-virtual {v0, v4, v2, v3, v5}, Lcom/android/camera/fragment/BaseFragmentDelegate;->delegateMode(Lio/reactivex/Completable;IZLcom/android/camera/fragment/lifeCircle/BaseLifecycleListener;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/ui/V6GestureRecognizer;->setCurrentModule(Lcom/android/camera/module/Module;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/camera/Camera$7;-><init>(Lcom/android/camera/Camera;Lcom/android/camera/module/BaseModule;)V
    ...
    invoke-virtual {v11, v13}, Lio/reactivex/Completable;->andThen(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-virtual {v0, v12, v2, v3, p0}, Lcom/android/camera/fragment/BaseFragmentDelegate;->delegateMode(Lio/reactivex/Completable;IZLcom/android/camera/fragment/lifeCircle/BaseLifecycleListener;)Lio/reactivex/disposables/Disposable;
...
.method public onPause()V
    ...
    invoke-direct {p0, v4}, Lcom/android/camera/Camera;->setScreenEffect(Z)V
...
.method public onResume()V
    ...
    invoke-static {p0, v1}, Lcom/android/camera/CameraStat;->recordPageStart(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/zxing/QRCodeManager;->resetQRScanExit(Z)V
...
.method public onSmartShutterClick()V
    ...
    invoke-virtual {v2}, Lcom/android/camera/module/BaseModule;->isDoingAction()Z
    ...
    invoke-virtual {v2, v4}, Lcom/android/camera/module/BaseModule;->onShutterButtonClick(I)V
...
.method public registerProtocol()V
    ...
    iget-object v3, p0, Lcom/android/camera/Camera;->mCameraIntentManager:Lcom/android/camera/CameraIntentManager;
    ...
    invoke-interface {v3, v7}, Lcom/android/camera/data/provider/DataProvider;->setTimeOut(Z)V
