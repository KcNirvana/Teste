...
.method private checkControlView(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v2, v4, p1}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->onViewTouchEvent(ILandroid/view/MotionEvent;)Z
    ...
    invoke-interface {v2, v4}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->isIndicatorVisible(I)Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-interface {v2, v3}, Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;->isEvAdjusted(Z)Z
...
.method private isCurrentModuleAlive()Z
    ...
    iget-object v1, p0, Lcom/android/camera/ui/V6GestureRecognizer;->mCurrentModule:Lcom/android/camera/module/Module;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/camera/ui/V6GestureRecognizer;->mCurrentModule:Lcom/android/camera/module/Module;

    invoke-interface {v1}, Lcom/android/camera/module/Module;->isCreated()Z
    ...
    invoke-interface {v1}, Lcom/android/camera/module/Module;->isDeparted()Z
