...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/amap/api/col/dt;->b:Z
...
.method protected constructor <init>(I)V
    ...
    iput-object v0, p0, Lcom/amap/api/col/dt;->c:[Ljava/lang/String;

    iput v1, p0, Lcom/amap/api/col/dt;->d:I

    iput-boolean v1, p0, Lcom/amap/api/col/dt;->e:Z

    iput v1, p0, Lcom/amap/api/col/dt;->f:I
...
.method private c(Ljava/lang/String;)V
    ...
    :try_start_0
    iget v0, p0, Lcom/amap/api/col/dt;->d:I
    ...
    iput v0, p0, Lcom/amap/api/col/dt;->d:I

    :cond_0
    iget-object v0, p0, Lcom/amap/api/col/dt;->c:[Ljava/lang/String;

    iget v1, p0, Lcom/amap/api/col/dt;->d:I
...
.method private e()Ljava/lang/String;
    ...
    :goto_1
    iget v2, p0, Lcom/amap/api/col/dt;->d:I

    if-ge v0, v2, :cond_2

    iget-object v2, p0, Lcom/amap/api/col/dt;->c:[Ljava/lang/String;
...
.method protected a(Ljava/util/List;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v2}, Lcom/amap/api/col/fi;->close()V
    :try_end_1
    ...
    :cond_3
    new-instance v2, Lcom/amap/api/col/fi;

    sget-object v0, Lcom/amap/api/col/fk;->a:Ljava/nio/charset/Charset;

    invoke-direct {v2, v3, v0}, Lcom/amap/api/col/fi;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    :try_end_4
    ...
    :goto_3
    :try_start_5
    invoke-virtual {v2}, Lcom/amap/api/col/fi;->a()Ljava/lang/String;
    ...
    :cond_7
    :goto_8
    iget-boolean v0, p0, Lcom/amap/api/col/dt;->e:Z

    if-eqz v0, :cond_10

    invoke-direct {p0}, Lcom/amap/api/col/dt;->e()Ljava/lang/String;
    ...
    :try_start_8
    invoke-direct {p0, v4}, Lcom/amap/api/col/dt;->c(Ljava/lang/String;)V

    iget v0, p0, Lcom/amap/api/col/dt;->f:I
    ...
    invoke-virtual {v0}, Lcom/amap/api/col/de;->f()[Ljava/lang/String;

    move-result-object v7

    invoke-static {v7, v4}, Lcom/amap/api/col/dt;->b([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/amap/api/col/dt;->e:Z

    iget-boolean v7, p0, Lcom/amap/api/col/dt;->e:Z

    if-eqz v7, :cond_9

    invoke-virtual {p0, v0}, Lcom/amap/api/col/dt;->a(Lcom/amap/api/col/de;)V
    ...
    iput v0, p0, Lcom/amap/api/col/dt;->f:I
    :try_end_8
    ...
    :try_start_11
    invoke-virtual {v0}, Lcom/amap/api/col/fi;->close()V
    :try_end_11
...
.method protected a(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lcom/amap/api/col/dt;->b:Z

    if-eqz v2, :cond_2

    sput-boolean v1, Lcom/amap/api/col/dt;->b:Z
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/amap/api/col/ek;->c()Z
    ...
    invoke-virtual {v4, v1}, Lcom/amap/api/col/ek;->c(Z)V
