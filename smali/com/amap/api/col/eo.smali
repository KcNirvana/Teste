...
# instance fields
.field final synthetic a:Lcom/amap/api/col/en;


# direct methods
.method constructor <init>(Lcom/amap/api/col/en;)V
    .locals 0

    iput-object p1, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;
...
.method public onLocationChanged(Landroid/location/Location;)V
    ...
    iget-object v1, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget-object v1, v1, Lcom/amap/api/col/en;->a:Landroid/os/Handler;
    ...
    :cond_3
    iget-object v2, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget v2, v2, Lcom/amap/api/col/en;->j:I

    invoke-static {p1, v2}, Lcom/amap/api/col/hu;->a(Landroid/location/Location;I)Z
    ...
    iget-object v2, v2, Lcom/amap/api/col/en;->d:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iget-object v2, v2, Lcom/amap/api/col/en;->e:Lcom/amap/api/col/ho;

    invoke-static {}, Lcom/amap/api/col/hu;->b()J

    move-result-wide v4

    invoke-virtual {v2, v4, v5}, Lcom/amap/api/col/ho;->b(J)V
    ...
    iget-object v2, v2, Lcom/amap/api/col/en;->f:Lcom/amap/api/location/CoordinateConverter;
    ...
    iget-object v0, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget-wide v4, v0, Lcom/amap/api/col/en;->h:J

    sub-long v4, v2, v4

    iget-object v0, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget-object v0, v0, Lcom/amap/api/col/en;->d:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iput-wide v2, v0, Lcom/amap/api/col/en;->h:J

    iget-object v0, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget-object v0, v0, Lcom/amap/api/col/en;->a:Landroid/os/Handler;
    ...
    :cond_5
    :goto_2
    sget-boolean v0, Lcom/amap/api/col/dh;->l:Z

    if-nez v0, :cond_6

    iget-object v0, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget-object v0, v0, Lcom/amap/api/col/en;->b:Landroid/content/Context;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/amap/api/col/hs;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/amap/api/col/hs;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)V

    :cond_6
    iget-object v0, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    invoke-static {v0}, Lcom/amap/api/col/en;->a(Lcom/amap/api/col/en;)J
    ...
    iget-boolean v0, v0, Lcom/amap/api/col/en;->g:Z
    ...
    iget-object v1, v1, Lcom/amap/api/col/en;->e:Lcom/amap/api/col/ho;

    invoke-static {v0, v1}, Lcom/amap/api/col/hp;->b(Landroid/content/Context;Lcom/amap/api/col/ho;)V

    iget-object v0, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    const/4 v1, 0x1

    iput-boolean v1, v0, Lcom/amap/api/col/en;->g:Z
    :try_end_0
    ...
    iget-object v4, p0, Lcom/amap/api/col/eo;->a:Lcom/amap/api/col/en;

    iget-object v4, v4, Lcom/amap/api/col/en;->d:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iget-wide v4, v4, Lcom/amap/api/col/en;->h:J
