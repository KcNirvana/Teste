.class public Lcom/amap/api/col/gz;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/amap/api/col/gz$a;
    }
.end annotation


# static fields
.field private static b:Lcom/amap/api/col/gz;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/api/col/gz;->b:Lcom/amap/api/col/gz;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amap/api/col/gz;->a:Ljava/util/Hashtable;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/amap/api/col/gz;->c:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/amap/api/col/gz;->d:Z

    return-void
.end method

.method private declared-synchronized a(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/amap/api/col/gz$a;
    .locals 18
    ...
    iget-object v2, v0, Lcom/amap/api/col/gz;->a:Ljava/util/Hashtable;
    ...
    check-cast v0, Lcom/amap/api/col/gz$a;

    move-object v4, v0

    invoke-virtual {v4}, Lcom/amap/api/col/gz$a;->b()Ljava/lang/String;
    ...
    invoke-direct {v0, v6, v1}, Lcom/amap/api/col/gz;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v0, v6, v8}, Lcom/amap/api/col/gz;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v3, v11}, Lcom/amap/api/col/gz;->a(Ljava/lang/String;Ljava/util/Hashtable;)V
    ...
    invoke-direct {v0, v3, v12}, Lcom/amap/api/col/gz;->a(Ljava/lang/String;Ljava/util/Hashtable;)V
    ...
    invoke-direct {v0, v15, v1}, Lcom/amap/api/col/gz;->a([D[D)[D
...
.method public static declared-synchronized a()Lcom/amap/api/col/gz;
    .locals 2

    const-class v1, Lcom/amap/api/col/gz;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/amap/api/col/gz;->b:Lcom/amap/api/col/gz;

    if-nez v0, :cond_0

    new-instance v0, Lcom/amap/api/col/gz;

    invoke-direct {v0}, Lcom/amap/api/col/gz;-><init>()V
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    invoke-static {}, Lcom/amap/api/col/hl;->s()Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0}, Lcom/amap/api/col/gz;->b()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p0}, Lcom/amap/api/col/gz;->c()V
    ...
    :cond_3
    iget-object v0, p0, Lcom/amap/api/col/gz;->a:Ljava/util/Hashtable;
    ...
    invoke-direct {p0, p2, p1}, Lcom/amap/api/col/gz;->a(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/amap/api/col/gz$a;
    ...
    invoke-virtual {v2}, Lcom/amap/api/col/gz$a;->a()Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    invoke-virtual {v2}, Lcom/amap/api/col/gz$a;->b()Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lcom/amap/api/col/hl;->b(J)Z
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/amap/api/col/hb;->a(Ljava/lang/String;Ljava/lang/StringBuilder;Landroid/content/Context;)Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/amap/api/col/gz;->d:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, p1, p2}, Lcom/amap/api/col/hb;->a(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_1
...
.method public declared-synchronized a(Ljava/lang/String;Ljava/lang/StringBuilder;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;Landroid/content/Context;Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p3}, Lcom/amap/api/col/gz;->a(Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v3}, Lcom/amap/api/col/hu;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/amap/api/col/gz;->a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    new-instance v1, Lcom/amap/api/col/gz$a;

    invoke-direct {v1}, Lcom/amap/api/col/gz$a;-><init>()V

    invoke-virtual {v1, p3}, Lcom/amap/api/col/gz$a;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)V
    ...
    :goto_2
    invoke-virtual {v1, v0}, Lcom/amap/api/col/gz$a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p3, p2, p4}, Lcom/amap/api/col/hb;->a(Ljava/lang/String;Lcom/amap/api/location/AMapLocation;Ljava/lang/StringBuilder;Landroid/content/Context;)V
    :try_end_2
    ...
    iget-object v1, p0, Lcom/amap/api/col/gz;->a:Ljava/util/Hashtable;
...
.method public a(Ljava/lang/String;Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
    ...
    invoke-static {p2}, Lcom/amap/api/col/hu;->a(Lcom/autonavi/aps/amapapi/model/AMapLocationServer;)Z
...
.method public b()Z
    ...
    iget-wide v4, p0, Lcom/amap/api/col/gz;->c:J
    ...
    :cond_1
    iget-object v4, p0, Lcom/amap/api/col/gz;->a:Ljava/util/Hashtable;
