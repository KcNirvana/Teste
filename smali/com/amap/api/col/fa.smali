...
# static fields
.field private static a:Lcom/amap/api/col/fa;
...
.method public static declared-synchronized c()Lcom/amap/api/col/fa;
    .locals 2

    const-class v1, Lcom/amap/api/col/fa;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/amap/api/col/fa;->a:Lcom/amap/api/col/fa;

    if-nez v0, :cond_0

    new-instance v0, Lcom/amap/api/col/fa;

    invoke-direct {v0}, Lcom/amap/api/col/fa;-><init>()V

    sput-object v0, Lcom/amap/api/col/fa;->a:Lcom/amap/api/col/fa;
