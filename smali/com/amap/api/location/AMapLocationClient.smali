...
.method private a(Landroid/content/Context;Landroid/content/Intent;)Lcom/amap/api/location/LocationManagerBase;
    ...
    invoke-static {p1, v1}, Lcom/amap/api/col/hr;->a(Landroid/content/Context;Lcom/amap/api/col/de;)V

    invoke-static {p1}, Lcom/amap/api/col/hr;->c(Landroid/content/Context;)Z

    move-result v0

    invoke-static {p1}, Lcom/amap/api/col/hr;->a(Landroid/content/Context;)V

    if-eqz v0, :cond_1

    const-string v2, "com.amap.api.location.LocationManagerWrapper"

    const-class v3, Lcom/amap/api/col/cd;
    ...
    invoke-direct {v0, p1, p2}, Lcom/amap/api/col/cd;-><init>(Landroid/content/Context;Landroid/content/Intent;)V
