...
.method private b(Landroid/content/Context;)Lcom/bumptech/glide/m;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/d/l;->d:Lcom/bumptech/glide/m;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/bumptech/glide/m;-><init>(Landroid/content/Context;Lcom/bumptech/glide/d/h;Lcom/bumptech/glide/d/m;)V

    iput-object v0, p0, Lcom/bumptech/glide/d/l;->d:Lcom/bumptech/glide/m;
...
# virtual methods
.method a(Landroid/app/FragmentManager;)Lcom/bumptech/glide/d/k;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x11
    .end annotation
...
.method a(Landroid/support/v4/app/u;)Lcom/bumptech/glide/d/o;
    .locals 3

    const-string v0, "com.bumptech.glide.manager"

    invoke-virtual {p1, v0}, Landroid/support/v4/app/u;->a(Ljava/lang/String;)Landroid/support/v4/app/n;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/u;->a()Landroid/support/v4/app/ac;

    move-result-object v1

    const-string v2, "com.bumptech.glide.manager"

    invoke-virtual {v1, v0, v2}, Landroid/support/v4/app/ac;->a(Landroid/support/v4/app/n;Ljava/lang/String;)Landroid/support/v4/app/ac;
...
.method public a(Landroid/app/Activity;)Lcom/bumptech/glide/m;
    ...
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/d/l;->a(Landroid/content/Context;)Lcom/bumptech/glide/m;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/bumptech/glide/d/l;->a(Landroid/content/Context;Landroid/app/FragmentManager;)Lcom/bumptech/glide/m;
...
.method public a(Landroid/content/Context;)Lcom/bumptech/glide/m;
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/d/l;->a(Landroid/support/v4/app/p;)Lcom/bumptech/glide/m;
...
.method a(Landroid/content/Context;Landroid/app/FragmentManager;)Lcom/bumptech/glide/m;
    ...
    invoke-virtual {p0, p2}, Lcom/bumptech/glide/d/l;->a(Landroid/app/FragmentManager;)Lcom/bumptech/glide/d/k;

    move-result-object v1

    invoke-virtual {v1}, Lcom/bumptech/glide/d/k;->b()Lcom/bumptech/glide/m;
    ...
    invoke-direct {v0, p1, v2, v3}, Lcom/bumptech/glide/m;-><init>(Landroid/content/Context;Lcom/bumptech/glide/d/h;Lcom/bumptech/glide/d/m;)V

    invoke-virtual {v1, v0}, Lcom/bumptech/glide/d/k;->a(Lcom/bumptech/glide/m;)V

    :cond_0
    return-object v0
.end method

.method a(Landroid/content/Context;Landroid/support/v4/app/u;)Lcom/bumptech/glide/m;
    .locals 4

    invoke-virtual {p0, p2}, Lcom/bumptech/glide/d/l;->a(Landroid/support/v4/app/u;)Lcom/bumptech/glide/d/o;

    move-result-object v1

    invoke-virtual {v1}, Lcom/bumptech/glide/d/o;->I()Lcom/bumptech/glide/m;
    ...
    invoke-virtual {v1}, Lcom/bumptech/glide/d/o;->H()Lcom/bumptech/glide/d/a;

    move-result-object v2

    invoke-virtual {v1}, Lcom/bumptech/glide/d/o;->J()Lcom/bumptech/glide/d/m;

    move-result-object v3

    invoke-direct {v0, p1, v2, v3}, Lcom/bumptech/glide/m;-><init>(Landroid/content/Context;Lcom/bumptech/glide/d/h;Lcom/bumptech/glide/d/m;)V

    invoke-virtual {v1, v0}, Lcom/bumptech/glide/d/o;->a(Lcom/bumptech/glide/m;)V

    :cond_0
    return-object v0
.end method

.method public a(Landroid/support/v4/app/p;)Lcom/bumptech/glide/m;
    .locals 1
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/p;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/p;->f()Landroid/support/v4/app/u;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lcom/bumptech/glide/d/l;->a(Landroid/content/Context;Landroid/support/v4/app/u;)Lcom/bumptech/glide/m;
