.class public Lcom/alipay/android/phone/inside/wallet/api/a;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/alipay/android/phone/inside/wallet/api/a$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/alipay/android/phone/inside/wallet/api/a;->a:[C

    return-void
.end method

.method public static a(Landroid/content/Context;I)Lcom/alipay/android/phone/inside/wallet/api/WalletStatusEnum;
    .locals 6

    if-gtz p1, :cond_0

    sget p1, Lcom/alipay/android/phone/inside/wallet/a/a;->a:I
    ...
    invoke-static {p0}, Lcom/alipay/android/phone/inside/wallet/api/a;->a(Landroid/content/Context;)Lcom/alipay/android/phone/inside/wallet/api/a$a;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-boolean v2, v1, Lcom/alipay/android/phone/inside/wallet/api/a$a;->a:Z
    ...
    const-string/jumbo v5, "CheckAlipayStatus|"
    ...
    const-string/jumbo v4, "ApkVerifyTool::checkAlipayStatus > WalletStatusEnum:"
    ...
    :cond_3
    invoke-static {v1}, Lcom/alipay/android/phone/inside/wallet/api/a;->a(Lcom/alipay/android/phone/inside/wallet/api/a$a;)Z
    ...
    :cond_4
    iget v1, v1, Lcom/alipay/android/phone/inside/wallet/api/a$a;->c:I
...
.method public static a(Landroid/content/Context;)Lcom/alipay/android/phone/inside/wallet/api/a$a;
    .locals 1

    const-string/jumbo v0, "com.eg.android.AlipayGphone"

    invoke-static {p0, v0}, Lcom/alipay/android/phone/inside/wallet/api/a;->a(Landroid/content/Context;Ljava/lang/String;)Lcom/alipay/android/phone/inside/wallet/api/a$a;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lcom/alipay/android/phone/inside/wallet/api/a$a;
    .locals 8
    ...
    new-instance v1, Lcom/alipay/android/phone/inside/wallet/api/a$a;

    invoke-direct {v1}, Lcom/alipay/android/phone/inside/wallet/api/a$a;-><init>()V
    ...
    iput-boolean v4, v1, Lcom/alipay/android/phone/inside/wallet/api/a$a;->a:Z

    :cond_0
    invoke-static {p0, p1}, Lcom/alipay/android/phone/inside/wallet/api/a;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;

    move-result-object v4

    iput-object v4, v1, Lcom/alipay/android/phone/inside/wallet/api/a$a;->b:Ljava/util/List;

    iget v0, v0, Landroid/content/pm/PackageInfo;->versionCode:I

    iput v0, v1, Lcom/alipay/android/phone/inside/wallet/api/a$a;->c:I
    :try_end_0
...
.method public static a(Lcom/alipay/android/phone/inside/wallet/api/a$a;)Z
    .locals 5
    ...
    :goto_0
    iget-object v0, p0, Lcom/alipay/android/phone/inside/wallet/api/a$a;->b:Ljava/util/List;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    sget-object v10, Lcom/alipay/android/phone/inside/wallet/api/a;->a:[C
