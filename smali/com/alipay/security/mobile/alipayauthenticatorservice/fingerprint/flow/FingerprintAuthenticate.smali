.class public Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;
.super Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuth;
.source "FingerprintAuthenticate.java"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->TAG:Ljava/lang/String;
...
.method private sendMessageToTee()Landroid/os/Bundle;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->mMessage:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->mContext:Landroid/content/Context;

    sget v3, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/ta/TACommands;->COMMAND_FINGERPRINT_AUTH:I
    ...
    iget-object v2, p0, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->mAAID:Ljava/lang/String;

    invoke-static {v2, v0, v1}, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/util/FingerprintDataUtil;->makeAuthResponse(Ljava/lang/String;Lorg/ifaa/ifaf/OperationHeader;Lcom/alipay/security/mobile/alipayauthenticatorservice/message/Result;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0}, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->getReponseType()I
    ...
    :cond_0
    sget-object v0, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->TAG:Ljava/lang/String;
    ...
    sget-object v1, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->TAG:Ljava/lang/String;
...
.method protected doTransaction()Landroid/os/Bundle;
    ...
    iget-boolean v0, p0, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->isFingerprintAuthSuccess:Z
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0}, Lcom/alipay/security/mobile/alipayauthenticatorservice/fingerprint/flow/FingerprintAuthenticate;->sendMessageToTee()Landroid/os/Bundle;
    :try_end_0
    ...
    const-string/jumbo v1, "fingerprint authenticate"
