...
.method public scheduleDirect(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-interface {v3, v0}, Ljava/util/concurrent/ScheduledExecutorService;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;

    move-result-object v2

    :goto_0
    invoke-static {v2}, Lio/reactivex/disposables/Disposables;->fromFuture(Ljava/util/concurrent/Future;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-interface {v3, v0, p2, p3, p4}, Ljava/util/concurrent/ScheduledExecutorService;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
