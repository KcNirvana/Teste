tableextension 57018 PurchCrMemoHdrTableExt extends "Purch. Cr. Memo Hdr."
{
    fields
    {
        ...
        field(58000; "Cost Amount"; Decimal)
        {
            Caption = 'Cost Amount';
            Editable = false;
            CalcFormula = Sum("Purch. Cr. Memo Line"."Cost Amount" WHERE("No." = FILTER(<> ''),
    ...
    procedure GetCrMemoHeaderAmount(): Decimal
    begin
