report 50021 "Export Fixed Assests"
{
    ...
    begin
        ...
        If FixedAsset.FindSet() then begin
            ...
            repeat
                ...
                TempTable.Code7 := FixedAsset."Car Maker";
                TempTable.Code8 := FixedAsset."Car Model";
                TempTable.Code9 := FixedAsset."Body Type";
                TempTable.Code10 := FixedAsset."ACRISS Code";
                TempTable.Code11 := FixedAsset."Transmission Type";
                TempTable.Code12 := FixedAsset."Fuel Type";
                TempTable.Insert();
                EntryNo += 1;
    ...
    begin
        ...
        if TempTable.FindSet() then begin
            ...
            ExportExcel.AddColumn(FA.FieldCaption("Car Maker"), FALSE, '', true, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
            ExportExcel.AddColumn(FA.FieldCaption("Car Model"), FALSE, '', true, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
            ExportExcel.AddColumn(FA.FieldCaption("Body Type"), FALSE, '', true, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
            ExportExcel.AddColumn(FA.FieldCaption("Acriss Code"), FALSE, '', true, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
            ExportExcel.AddColumn(FA.FieldCaption("Transmission Type"), FALSE, '', true, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
            ExportExcel.AddColumn(FA.FieldCaption("Fuel Type"), FALSE, '', true, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
            REPEAT
                ExportExcel.NewRow;
                ...
                ExportExcel.AddColumn(TempTable.Code7, FALSE, '', FALSE, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
                ExportExcel.AddColumn(TempTable.Code8, FALSE, '', FALSE, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
                ExportExcel.AddColumn(TempTable.Code9, FALSE, '', FALSE, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
                ExportExcel.AddColumn(TempTable.Code10, FALSE, '', FALSE, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
                ExportExcel.AddColumn(TempTable.Code11, FALSE, '', FALSE, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
                ExportExcel.AddColumn(TempTable.Code12, FALSE, '', FALSE, FALSE, FALSE, '', ExportExcel."Cell Type"::Text);
