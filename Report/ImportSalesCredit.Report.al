report 50019 "Import Sales Credit Memos"
{
    ...
    begin
        ...
        if CustomerCrMemoValid(pTmpSalesLine."Description 2", pTmpSalesLine."Sell-to Customer No.") then
    ...
    begin
        ...
        if pTmpSalesLine.FindSet() then begin
            ...
            lSalesHeader.Validate("Order Date", pTmpSalesLine."FA Posting Date");
            lSalesHeader.Validate("Shipment Date", pTmpSalesLine."FA Posting Date");
    ...
    local procedure CustomerCrMemoValid(pCustomerCrMemo: Text; pCustomerNo: Code[20]): Boolean
    var
    ...
    local procedure SetType(ValueAtCell: Text): Enum "Purchase Line Type"
    var
