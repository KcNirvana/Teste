codeunit 57006 "Matrix Management Class0"
{
    ...
    procedure DimToCaptions(var CaptionSet: array[32] of Text[80]; var MatrixRecords: array[32] of Record "Dimension Code Buffer"; DimensionCode: Code[20]; FirstColumn: Text; LastColumn: Text; var NumberOfColumns: Integer; ShowColumnName: Boolean; var CaptionRange: Text; DimensionValueFilter: Text; ShowBlockedDimensions: Boolean)
    var
    ...
    begin
        ...
        IF NOT ShowBlockedDimensions THEN
    ...
    procedure GenerateDimColumnCaption(DimensionCode: Code[20]; DimFilter: Text; SetWanted: Option; var RecordPosition: Text; FirstColumn: Text; LastColumn: Text; var CaptionSet: array[32] of Text[80]; var DimensionCodeBuffer: array[32] of Record "Dimension Code Buffer"; var NumberOfColumns: Integer; ShowColumnName: Boolean; var CaptionRange: Text; ShowBlockedDimensions: Boolean)
    begin
        SetDimColumnSet(
        ...
        DimToCaptions(
          ...
          FirstColumn, LastColumn, NumberOfColumns, ShowColumnName, CaptionRange, DimFilter, ShowBlockedDimensions);
    end;
