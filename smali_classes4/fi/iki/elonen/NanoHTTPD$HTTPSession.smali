...
.method public execute()V
    ...
    :try_start_2
    iget v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->rlen:I

    add-int/2addr v5, v4

    iput v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->rlen:I

    iget v4, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->rlen:I

    invoke-direct {p0, v2, v4}, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->findHeaderEnd([BI)I

    move-result v4

    iput v4, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->splitbyte:I
    ...
    iget v6, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->rlen:I
    ...
    iget-object v4, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->parms:Ljava/util/Map;

    iget-object v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->headers:Ljava/util/Map;

    invoke-direct {p0, v0, v2, v4, v5}, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->decodeHeader(Ljava/io/BufferedReader;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iget-object v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->remoteIp:Ljava/lang/String;
    ...
    iget-object v2, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->this$0:Lfi/iki/elonen/NanoHTTPD;
    ...
    invoke-virtual {v2, p0}, Lfi/iki/elonen/NanoHTTPD;->serve(Lfi/iki/elonen/NanoHTTPD$IHTTPSession;)Lfi/iki/elonen/NanoHTTPD$Response;
    ...
    iget-object v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->cookies:Lfi/iki/elonen/NanoHTTPD$CookieHandler;

    invoke-virtual {v5, v2}, Lfi/iki/elonen/NanoHTTPD$CookieHandler;->unloadQueue(Lfi/iki/elonen/NanoHTTPD$Response;)V

    iget-object v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->method:Lfi/iki/elonen/NanoHTTPD$Method;

    invoke-virtual {v2, v5}, Lfi/iki/elonen/NanoHTTPD$Response;->setRequestMethod(Lfi/iki/elonen/NanoHTTPD$Method;)V

    iget-object v5, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->this$0:Lfi/iki/elonen/NanoHTTPD;

    invoke-virtual {v5, v2}, Lfi/iki/elonen/NanoHTTPD;->useGzipWhenAccepted(Lfi/iki/elonen/NanoHTTPD$Response;)Z
    ...
    :cond_7
    invoke-virtual {v2, v3}, Lfi/iki/elonen/NanoHTTPD$Response;->setGzipEncoding(Z)V

    invoke-virtual {v2, v0}, Lfi/iki/elonen/NanoHTTPD$Response;->setKeepAlive(Z)V

    iget-object v1, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->outputStream:Ljava/io/OutputStream;

    invoke-virtual {v2, v1}, Lfi/iki/elonen/NanoHTTPD$Response;->send(Ljava/io/OutputStream;)V

    if-eqz v0, :cond_8

    invoke-virtual {v2}, Lfi/iki/elonen/NanoHTTPD$Response;->isCloseConnection()Z
    ...
    invoke-static {v2, v3, v0}, Lfi/iki/elonen/NanoHTTPD;->newFixedLengthResponse(Lfi/iki/elonen/NanoHTTPD$Response$IStatus;Ljava/lang/String;Ljava/lang/String;)Lfi/iki/elonen/NanoHTTPD$Response;

    move-result-object v0

    iget-object v2, p0, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->outputStream:Ljava/io/OutputStream;

    invoke-virtual {v0, v2}, Lfi/iki/elonen/NanoHTTPD$Response;->send(Ljava/io/OutputStream;)V
...
.method public parseBody(Ljava/util/Map;)V
    ...
    iget-object v6, v1, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->method:Lfi/iki/elonen/NanoHTTPD$Method;
    ...
    invoke-direct {v1, v3, v12, v6, v2}, Lfi/iki/elonen/NanoHTTPD$HTTPSession;->saveTmpFile(Ljava/nio/ByteBuffer;IILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_8
    :goto_3
    invoke-static {v5}, Lfi/iki/elonen/NanoHTTPD;->access$000(Ljava/lang/Object;)V
