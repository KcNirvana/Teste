.class public Lcom/miui/video/player/service/webview/MiVideoWebview;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->initMiVideoWebview()V
...
.method private logWebViewSettings()V
    .locals 4

    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->getSettings()Landroid/webkit/WebSettings;
    ...
    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->toString()Ljava/lang/String;
    ...
    const-string v3, "; getMixedContentMode="
...
# virtual methods
.method protected initMiVideoWebview()V
    .locals 0

    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->initUIStyle()V

    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->initWebSettings()V

    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->initWebViewClient()V

    invoke-virtual {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->initWebChromeClient()V

    return-void
.end method

.method protected initUIStyle()V
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->setOverScrollMode(I)V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->setScrollBarStyle(I)V
...
.method protected initWebChromeClient()V
    ...
    new-instance v0, Lcom/miui/video/player/service/webview/MiVideoWebview$2;

    invoke-direct {v0, p0}, Lcom/miui/video/player/service/webview/MiVideoWebview$2;-><init>(Lcom/miui/video/player/service/webview/MiVideoWebview;)V

    invoke-virtual {p0, v0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->setWebChromeClient(Landroid/webkit/WebChromeClient;)V
...
.method protected initWebSettings()V
    ...
    invoke-direct {p0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->logWebViewSettings()V
...
.method protected initWebViewClient()V
    ...
    new-instance v0, Lcom/miui/video/player/service/webview/MiVideoWebview$1;

    invoke-direct {v0, p0}, Lcom/miui/video/player/service/webview/MiVideoWebview$1;-><init>(Lcom/miui/video/player/service/webview/MiVideoWebview;)V

    invoke-virtual {p0, v0}, Lcom/miui/video/player/service/webview/MiVideoWebview;->setWebViewClient(Landroid/webkit/WebViewClient;)V
