.class Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;
.super Lcom/miui/zeus/columbus/remote/e;
.source "NativeAdServer.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/miui/zeus/columbus/ad/nativead/NativeAdResponse;",
        ">;"
    }
.end annotation
...
.field private static final TAG:Ljava/lang/String; = "NativeAdServer"
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-object v0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->MI_MARKET_PACKAGE_NAME:Ljava/lang/String;
...
.method private buildAdSdkInfo()Lorg/json/JSONObject;
    ...
    const-string v2, "NativeAdServer"
...
.method private buildAppInfo()Lorg/json/JSONObject;
    ...
    iget-object v2, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mContext:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mContext:Landroid/content/Context;
...
.method private buildAppVersionInfo()Lorg/json/JSONObject;
    ...
    sget-object v3, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->MI_MARKET_PACKAGE_NAME:Ljava/lang/String;
...
.method private buildImpRequest()Lorg/json/JSONArray;
    ...
    iget-object v3, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mAdRequest:Lcom/miui/zeus/columbus/ad/enity/AdRequest;
...
.method private buildUserInfo(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    const-string v1, "NativeAdServer"
...
.method protected buildHttpRequest()Lcom/miui/zeus/columbus/remote/HttpRequest;
    ...
    iget-object v1, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mUrl:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->buildDeviceInfo()Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->buildImpRequest()Lorg/json/JSONArray;
    ...
    invoke-direct {p0, v3}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->buildUserInfo(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->buildAppInfo()Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->buildAppVersionInfo()Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->buildAdSdkInfo()Lorg/json/JSONObject;
...
.method protected connect()Lcom/miui/zeus/columbus/remote/d;
    ...
    iget-object v0, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->connect(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/miui/zeus/columbus/remote/d;
...
.method protected getTagPrefix()Ljava/lang/String;
    ...
    const-string v0, "NativeAdServer"
...
.method protected bridge synthetic parseHttpResponse(Ljava/lang/String;)Lcom/miui/zeus/columbus/ad/enity/IResponseEntity;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->parseHttpResponse(Ljava/lang/String;)Lcom/miui/zeus/columbus/ad/nativead/NativeAdResponse;
...
.method protected parseHttpResponse(Ljava/lang/String;)Lcom/miui/zeus/columbus/ad/nativead/NativeAdResponse;
    .locals 0

    invoke-static {p1}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdResponse;->deserialize(Ljava/lang/String;)Lcom/miui/zeus/columbus/ad/nativead/NativeAdResponse;
...
.method public requestNativeAd(Landroid/content/Context;Lcom/miui/zeus/columbus/ad/enity/AdRequest;)Lcom/miui/zeus/columbus/remote/d;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "request native ad"

    invoke-static {v0, v1}, Lcom/miui/zeus/columbus/util/i;->d(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->mAdRequest:Lcom/miui/zeus/columbus/ad/enity/AdRequest;

    invoke-virtual {p0}, Lcom/miui/zeus/columbus/ad/nativead/NativeAdServer;->connect()Lcom/miui/zeus/columbus/remote/d;
